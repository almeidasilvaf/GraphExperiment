...
g
#> IGRAPH 96e1eb4 UNW- 200 20096 -- 
#> + attr: name (v/c), degree (v/n), weight (e/n)
#> + edges from 96e1eb4 (vertex names):
...
fg
#> IGRAPH e7f4620 UNW- 200 202 -- 
#> + attr: name (v/c), weight (e/n)
#> + edges from e7f4620 (vertex names):
...
#> graphs(2): cor fcor
graph(ge_subset, "cor")
#> IGRAPH 470114d UNW- 10 55 -- 
#> + attr: name (v/c), degree (v/n), pathway (v/c), coding (v/l), weight
#> | (e/n)
#> + edges from 470114d (vertex names):
